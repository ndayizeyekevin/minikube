...
function initNavigation() {
  ...
  navLinks.forEach(link => {
    ...
    if (currentPath === href || (currentPath === '/' && href === '/') || 
        currentPath.endsWith(href.split('/').pop())) {
...
function initAssignmentFiltering() {
  ...
  // Attach click listeners to existing filter buttons
...
function filterAssignments(e) {
  ...
  // Filter items based on their class
...
console.log('%cThis is a dynamic class website built with HTML, CSS, and JavaScript.', 'color: #666; font-size: 14px;');
